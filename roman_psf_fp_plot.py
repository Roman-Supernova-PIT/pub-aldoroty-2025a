...
def roman_sca_plot(data_array, sca_order, ptype='image', cmap='bwr', residual_plot=True, clabel=None, title=None,
...
band = "R062"
data_array = load_all_data(band=band)
roman_sca_plot(data_array, np.array(list(range(1, 19))), ptype="image", residual_plot=False, savefig=True, show_sca_id=True, title=band, clabel=r"PSF FWHM [arcsec]", cmap=cm.cividis, savepath=f"{band}.pdf")
